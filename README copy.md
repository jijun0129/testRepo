...
> [!NOTE]
>ChatGPT와 같은 생성형 AI의 등장으로 양질의 데이터셋 부족 문제가 대두
 멀티모달 임베딩 기술을 활용해 다양한 데이터 소스를 통합하고, 이를 하나의 임베딩 공간에 표현함으로써 이러한 문제를 해결
> 멀티모달 모델을 활용해 데이터에서 필요한 정보를 추출하고, 텍스트 프롬프트의 정확성을 판별할 수 있는 페이지를 개발할 계획
